# WMI Event Subscription Persistence – L3 Native Detection Rule

## Threat Focus

WMI Event Subscription Persistence is detected using pure native telemetry (no external TI) at L3 fidelity.
...
| extend Reason = "wmi-event-subscription – baseline native behavioural detection; tune conditions to match your environment."
