# WinRM-based Lateral Execution – L3 Native Detection Rule

## Threat Focus

WinRM-based Lateral Execution is detected using pure native telemetry (no external TI) at L3 fidelity.
...
| extend Reason = "winrm-lateral-execution – baseline native behavioural detection; tune conditions to match your environment."
